...
public class MonitorUtil {
	...
	public static MonitorInfoBean getMonitorInfoBean() throws Exception {
		...
		// change to Mb
		diskTotalSpace = Math
				.round(((double) diskTotalSpace / mb) * 100 / 100.0);
		diskFreeSpace = Math.round(((double) diskFreeSpace / mb) * 100 / 100.0);
		...
		infoBean.setDiskTotalSpace(diskTotalSpace);
		infoBean.setDiskFreeSpace(diskFreeSpace);
		infoBean.setDiskUsedSpace(diskTotalSpace - diskFreeSpace);
		return infoBean;
	}
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("磁盘总容量：" + monitorInfo.getDiskTotalSpace() + " Mb");
		System.out.println("磁盘空闲容量：" + monitorInfo.getDiskFreeSpace() + " Mb");
		System.out.println("磁盘已用容量：" + monitorInfo.getDiskUsedSpace() + " Mb");
	}
