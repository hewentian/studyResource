...
/**
 * @Description 根据文件内容，搜索文件, 参考网址：http://lucene.apache.org/core/4_1_0/demo/
 * @author Tim
 * @date 2014-5-27下午03:08:15
 * @version 1.0
 * @since JDK 1.7
 */
public class SearchFiles {
	public static void main(String[] args) throws Exception {
		String index = "E:\\lucene\\luceneIndex"; // 索引的位置
		String field = "contents"; // 根据内容查找
		int repeat = 0;
		boolean raw = false;
		String queryString = "creating a Lucene index"; // 查找英文，中文会有问题。
		int hitsPerPage = 5;
